      ...
      <div className="flex-1 max-w-lg pl-4 md:pl-8 mb-8 md:mb-0">
        ...
        <div className="flex items-center justify-start mb-6 mr-4">
          <a
            ...
            className="px-6 mr-4 py-3 bg-blue-600 dark:bg-blue-400 text-white dark:text-gray-900 font-semibold rounded-md shadow-lg hover:bg-blue-700 dark:hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-lg"
          >
            myResume
          </a>
              <a
